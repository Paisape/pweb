  ...
  <div class="mx-auto max-w-site px-5">
        ...
        <div class="relative dropdown-parent">
          ...
          <div class="dropdown-wrap w-64">
            <div class="rounded-2xl border border-slate-100 bg-white p-2.5 shadow-xl space-y-1">
              <a href="/excel-reconciliation-tool" class="flex items-center gap-3 rounded-xl px-3.5 py-2.5 text-[14px] font-semibold text-brand hover:bg-mist transition"><svg class="h-4 w-4 text-brand" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"/><path d="M14 2v6h6"/><path d="M16 13H8"/><path d="M16 17H8"/></svg>Excel Reconciliation Tool</a>
    ...
    <div id="mobileMenu" class="md:hidden mt-2 hidden max-h-[75vh] overflow-y-auto rounded-2xl border border-slate-100 bg-white p-3 shadow-xl">
      ...
      <div class="rounded-xl bg-blue-50/60 p-2 my-1 space-y-1">
        ...
        <a href="/excel-reconciliation-tool" class="block rounded-lg px-3 py-2 text-[13.5px] font-semibold text-brand hover:bg-white transition">Excel Reconciliation Tool</a>
