...
<head>
  ...
  <link rel="canonical" href="https://paisape.in/pos-solution">
  <meta name="robots" content="index, follow, max-image-preview:large, max-snippet:-1, max-video-preview:-1">
<meta charset="UTF-8" />
<meta name="viewport" content="width=device-width, initial-scale=1" />
<title>POS Solution � Paisape</title>
<meta name="description" content="Transform your retail business with our advanced Point of Sale (POS) solution. Accept payments anywhere, anytime with secure and lightning-fast transaction" />
...
<link rel="stylesheet" href="/css/style.css">
  ...
  <meta property="og:title" content="POS Solution — Paisape" />
  <meta property="og:description" content="Deploy smart POS terminals with Paisape. Accept card, UPI and wallet payments with real-time settlement and analytics." />
...
<section class="relative overflow-hidden bg-gradient-to-b from-[#EAF4FD] via-[#F4FAFE] to-white pt-36 pb-14 md:pt-44 md:pb-20">
  ...
  <div class="relative mx-auto max-w-site px-5">
    <p data-reveal class="mb-4 text-[11px] font-bold uppercase tracking-[0.18em] text-brand">Transform your retail</p>

    <h1 class="max-w-3xl font-display text-[36px] font-extrabold leading-[1.14] tracking-tight text-ink sm:text-[44px]">
      <span data-reveal data-delay="80">POS</span> <span data-reveal data-delay="180" class="text-brand">Solution</span>
    </h1>

    <p data-reveal data-delay="300" class="mt-5 max-w-2xl text-[15.5px] leading-relaxed text-body">Transform your retail business with our advanced Point of Sale (POS) solution. Accept payments anywhere, anytime with secure and lightning-fast transaction processing. Supports credit cards, debit cards, UPI, and contactless payments.</p>
    ...
    <div class="mt-8 flex flex-wrap gap-2.5">
        <span data-reveal data-delay="560" class="flex items-center gap-1.5 rounded-full border border-slate-200 bg-white px-3.5 py-1.5 text-[11.5px] font-medium text-ink2 transition hover:-translate-y-0.5 hover:border-brand"><span class="h-1.5 w-1.5 rounded-full bg-brand"></span>Multi-Payment Support</span>
        <span data-reveal data-delay="620" class="flex items-center gap-1.5 rounded-full border border-slate-200 bg-white px-3.5 py-1.5 text-[11.5px] font-medium text-ink2 transition hover:-translate-y-0.5 hover:border-brand"><span class="h-1.5 w-1.5 rounded-full bg-brand"></span>Instant Settlements</span>
        <span data-reveal data-delay="680" class="flex items-center gap-1.5 rounded-full border border-slate-200 bg-white px-3.5 py-1.5 text-[11.5px] font-medium text-ink2 transition hover:-translate-y-0.5 hover:border-brand"><span class="h-1.5 w-1.5 rounded-full bg-brand"></span>Advanced Analytics</span>
    </div>
  </div>
</section>
  ...
  <div class="mx-auto max-w-site px-5">
    ...
    <div class="mt-12 grid gap-5 sm:grid-cols-2 lg:grid-cols-3">
      <article data-reveal data-delay="0" class="card-lift rounded-2xl border border-slate-100 bg-white p-6 shadow-sm">
        ...
        <h3 class="font-display text-[15px] font-bold text-ink">Multi-Payment Support</h3>
        <p class="mt-2 text-[13px] leading-relaxed text-body">Accept credit cards, debit cards, UPI, wallets and contactless taps on a single certified terminal.</p>
      </article>
      <article data-reveal data-delay="80" class="card-lift rounded-2xl border border-slate-100 bg-white p-6 shadow-sm">
        ...
        <h3 class="font-display text-[15px] font-bold text-ink">Instant Settlements</h3>
        <p class="mt-2 text-[13px] leading-relaxed text-body">Same-day settlement of card and UPI collections directly into the merchant's operating account.</p>
      </article>
      <article data-reveal data-delay="160" class="card-lift rounded-2xl border border-slate-100 bg-white p-6 shadow-sm">
        ...
        <h3 class="font-display text-[15px] font-bold text-ink">Advanced Analytics</h3>
        <p class="mt-2 text-[13px] leading-relaxed text-body">Track sales by store, terminal and payment method, with daily reports and exportable MIS files.</p>
      </article>
    </div>
  </div>
</section>
...
<section class="relative overflow-hidden bg-deep py-20 md:py-24">
  ...
  <div class="relative mx-auto max-w-3xl px-5 text-center">
    <h2 data-reveal class="font-display text-[30px] font-extrabold leading-tight tracking-tight text-white sm:text-[40px]">Ready to modernise your checkout counter?</h2>
    <p data-reveal data-delay="120" class="mx-auto mt-5 max-w-xl text-[15px] leading-relaxed text-slate-400">Talk to our team about terminal models, rental options and rollout across your store network.</p>
