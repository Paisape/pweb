...
<title>Digital Merchant Onboarding â€” Paisape</title>
<meta name="description" content="Automate your entire merchant lifecycle. From eKYC and document verification to underwriting and instant activations, onboard merchants in minutes instead " />
...
<section class="relative overflow-hidden bg-gradient-to-b from-[#EAF4FD] via-[#F4FAFE] to-white pt-36 pb-14 md:pt-44 md:pb-20">
  ...
  <div class="relative mx-auto max-w-site px-5">
    <p data-reveal class="mb-4 text-[11px] font-bold uppercase tracking-[0.18em] text-brand">Compliance &bull; Onboarding</p>

    <h1 class="max-w-3xl font-display text-[36px] font-extrabold leading-[1.14] tracking-tight text-ink sm:text-[44px]">
      <span data-reveal data-delay="80">Digital</span> <span data-reveal data-delay="180" class="text-brand">Merchant Onboarding</span>
    </h1>

    <p data-reveal data-delay="300" class="mt-5 max-w-2xl text-[15.5px] leading-relaxed text-body">Automate your entire merchant lifecycle. From eKYC and document verification to underwriting and instant activations, onboard merchants in minutes instead of days.</p>
    ...
    <div class="mt-8 flex flex-wrap gap-2.5">
        <span data-reveal data-delay="560" class="flex items-center gap-1.5 rounded-full border border-slate-200 bg-white px-3.5 py-1.5 text-[11.5px] font-medium text-ink2 transition hover:-translate-y-0.5 hover:border-brand"><span class="h-1.5 w-1.5 rounded-full bg-brand"></span>Automated eKYC</span>
        <span data-reveal data-delay="620" class="flex items-center gap-1.5 rounded-full border border-slate-200 bg-white px-3.5 py-1.5 text-[11.5px] font-medium text-ink2 transition hover:-translate-y-0.5 hover:border-brand"><span class="h-1.5 w-1.5 rounded-full bg-brand"></span>Video KYC Integration</span>
        <span data-reveal data-delay="680" class="flex items-center gap-1.5 rounded-full border border-slate-200 bg-white px-3.5 py-1.5 text-[11.5px] font-medium text-ink2 transition hover:-translate-y-0.5 hover:border-brand"><span class="h-1.5 w-1.5 rounded-full bg-brand"></span>Instant PAN Verification</span>
        <span data-reveal data-delay="740" class="flex items-center gap-1.5 rounded-full border border-slate-200 bg-white px-3.5 py-1.5 text-[11.5px] font-medium text-ink2 transition hover:-translate-y-0.5 hover:border-brand"><span class="h-1.5 w-1.5 rounded-full bg-brand"></span>Bank Account Validation</span>
        <span data-reveal data-delay="800" class="flex items-center gap-1.5 rounded-full border border-slate-200 bg-white px-3.5 py-1.5 text-[11.5px] font-medium text-ink2 transition hover:-translate-y-0.5 hover:border-brand"><span class="h-1.5 w-1.5 rounded-full bg-brand"></span>Risk &amp; Underwriting</span>
    </div>
  </div>
</section>
  ...
  <div class="mx-auto max-w-site px-5">
    ...
    <div class="mt-12 grid gap-5 sm:grid-cols-2 lg:grid-cols-3">
      <article data-reveal data-delay="0" class="card-lift rounded-2xl border border-slate-100 bg-white p-6 shadow-sm">
        ...
        <h3 class="font-display text-[15px] font-bold text-ink">Automated eKYC</h3>
        <p class="mt-2 text-[13px] leading-relaxed text-body">Verify merchant identities instantly using Aadhaar XML, biometric, or OTP-based eKYC flows directly from your portal.</p>
      </article>
      <article data-reveal data-delay="80" class="card-lift rounded-2xl border border-slate-100 bg-white p-6 shadow-sm">
        ...
        <h3 class="font-display text-[15px] font-bold text-ink">Video KYC Integration</h3>
        <p class="mt-2 text-[13px] leading-relaxed text-body">Conduct RBI-compliant Video KYC (V-CIP) for high-volume or high-risk merchants without leaving the onboarding flow.</p>
      </article>
      <article data-reveal data-delay="160" class="card-lift rounded-2xl border border-slate-100 bg-white p-6 shadow-sm">
        ...
        <h3 class="font-display text-[15px] font-bold text-ink">Instant PAN Verification</h3>
        <p class="mt-2 text-[13px] leading-relaxed text-body">Automatically fetch and verify business and individual PAN details against the NSDL database in real-time.</p>
      </article>
      <article data-reveal data-delay="0" class="card-lift rounded-2xl border border-slate-100 bg-white p-6 shadow-sm">
        <div class="mb-5 inline-flex h-10 w-10 items-center justify-center rounded-xl bg-brandLt text-brand">
        ...
        <h3 class="font-display text-[15px] font-bold text-ink">Bank Account Validation</h3>
        <p class="mt-2 text-[13px] leading-relaxed text-body">Use penny drop verification (IMPS) to ensure the merchant settlement bank account is active and matches their identity.</p>
      </article>
      <article data-reveal data-delay="80" class="card-lift rounded-2xl border border-slate-100 bg-white p-6 shadow-sm">
        <div class="mb-5 inline-flex h-10 w-10 items-center justify-center rounded-xl bg-brandLt text-brand">
        ...
        <h3 class="font-display text-[15px] font-bold text-ink">Risk &amp; Underwriting</h3>
        <p class="mt-2 text-[13px] leading-relaxed text-body">Rule-based underwriting engine to automatically approve, hold, or reject merchants based on custom risk parameters.</p>
      </article>
      <article data-reveal data-delay="160" class="card-lift rounded-2xl border border-slate-100 bg-white p-6 shadow-sm">
        <div class="mb-5 inline-flex h-10 w-10 items-center justify-center rounded-xl bg-brandLt text-brand">
        ...
        <h3 class="font-display text-[15px] font-bold text-ink">White-Label Portals</h3>
        <p class="mt-2 text-[13px] leading-relaxed text-body">Provide a seamless, fully branded onboarding journey for your agents and sub-merchants on mobile and web.</p>
      </article>
    </div>
  </div>
</section>
...
<section class="relative overflow-hidden bg-deep py-20 md:py-24">
  ...
  <div class="relative mx-auto max-w-3xl px-5 text-center">
    <h2 data-reveal class="font-display text-[30px] font-extrabold leading-tight tracking-tight text-white sm:text-[40px]">Ready to onboard merchants in minutes?</h2>
    <p data-reveal data-delay="120" class="mx-auto mt-5 max-w-xl text-[15px] leading-relaxed text-slate-400">Talk to our team about your current drop-off points and the checks you need automated.</p>
