  ...
  <div class="mx-auto max-w-3xl px-5">
    ...
    <div class="mt-12 space-y-3">
      ...
      <div data-reveal data-delay="240" class="faq rounded-2xl border border-slate-100 bg-white shadow-sm">
        ...
        <div class="faq-body"><p class="px-6 pb-5 text-[13.5px] leading-relaxed text-body">Paisape is ISO 9001:2015 QMS &amp; ISO 27001:2022 ISMS certified (IAF validated), a DPIIT Recognized Startup (DIPP282292), and PayU Certified Partner with AES-256 encryption and complete audit trails compliant with RBI &amp; NPCI guidelines.</p></div>
      </div>
    </div>
  </div>
</section>
  ...
  <div class="marquee">
    <div class="track animate-marquee-slow gap-12 pr-12">
      <div class="flex shrink-0 items-center gap-12 pr-12" data-mq-group>
        ...
        <a href="https://pmny.in/er1smJcqj6z5" target="_blank" rel="noopener" class="whitespace-nowrap font-display text-[17px] font-extrabold text-brand transition hover:text-brandDk inline-flex items-center gap-1.5"><svg class="h-4 w-4 text-emerald-500" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.2"><path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z"/><path d="m9 12 2 2 4-4"/></svg>PayU Certified Partner</a>
