...
<article class="bg-white pt-32 pb-16 md:pt-40 md:pb-24">
  <div class="mx-auto max-w-[800px] px-5">
    ...
    <div class="mt-8 flex items-center gap-4 border-y border-slate-100 py-6">
      <span class="flex h-12 w-12 items-center justify-center rounded-full bg-brandLt font-display text-[15px] font-bold text-brand">RK</span>
      <div>
        <p class="text-[14px] font-semibold text-ink">Rohit Kulkarni</p>
        <p class="text-[13px] text-body/70">24 July 2026</p>
      </div>
    </div>
