...
<!-- Official Navigation Header (Identical to upi-qr-generator) -->
    ...
    <div id="navInner" class="mt-4 flex items-center justify-between rounded-2xl border border-transparent px-5 py-3 transition-all duration-500 bg-white/90 backdrop-blur-md shadow-sm">
        ...
        <div class="relative dropdown-parent">
          ...
          <div class="dropdown-wrap w-64">
            <div class="rounded-2xl border border-slate-100 bg-white p-2.5 shadow-xl space-y-1">
              ...
              <a href="/excel-reconciliation-tool" class="flex items-center gap-3 rounded-xl px-3.5 py-2.5 text-[14px] font-bold text-brand bg-brand/5 hover:bg-brand/10 transition">
                ...
                Free Excel Reconciliation Tool
              </a>
            </div>
          </div>
        </div>
      ...
      <div class="flex items-center gap-3">
        ...
        <button id="burger" aria-label="Open menu" aria-expanded="false" class="md:hidden rounded-xl border border-slate-200 bg-white p-2.5 text-ink">
          <svg class="h-5 w-5" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.2"><path d="M4 7h16M4 12h16M4 17h16"/></svg>
        </button>
      </div>
    </div>
  </div>
