...
<head>
  ...
  <link rel="canonical" href="https://paisape.in/neobanking">
  <meta name="robots" content="index, follow, max-image-preview:large, max-snippet:-1, max-video-preview:-1">
<meta charset="UTF-8" />
<meta name="viewport" content="width=device-width, initial-scale=1" />
<title>Neobanking Solution � Paisape</title>
<meta name="description" content="Paisape's neobanking stack lets you open CASA accounts, issue cards and run mobile banking - phygital, API-first and live in weeks, not years." />
...
<link rel="stylesheet" href="/css/style.css">
  ...
  <meta property="og:title" content="Neobanking & Issuing Solution — Paisape" />
  <meta property="og:description" content="Launch your neobank or fintech product with Paisape issuing infrastructure. Prepaid cards, wallets and banking APIs." />
...
<section class="relative overflow-hidden bg-gradient-to-b from-[#EAF4FD] via-[#F4FAFE] to-white pt-36 pb-14 md:pt-44 md:pb-20">
  ...
  <div class="relative mx-auto max-w-site px-5">
    <p data-reveal class="mb-4 text-[11px] font-bold uppercase tracking-[0.18em] text-brand">Issuing Solutions &bull; Neobanking</p>

    <h1 class="max-w-3xl font-display text-[36px] font-extrabold leading-[1.14] tracking-tight text-ink sm:text-[44px]">
      <span data-reveal data-delay="80">Neobanking</span> <span data-reveal data-delay="180" class="text-brand">solution</span>
    </h1>

    <p data-reveal data-delay="300" class="mt-5 max-w-2xl text-[15.5px] leading-relaxed text-body">Paisape's neobanking stack lets you open CASA accounts, issue cards and run mobile banking &mdash; phygital, API-first and live in weeks, not years.</p>
    ...
    <div class="mt-8 flex flex-wrap gap-2.5">
        <span data-reveal data-delay="560" class="flex items-center gap-1.5 rounded-full border border-slate-200 bg-white px-3.5 py-1.5 text-[11.5px] font-medium text-ink2 transition hover:-translate-y-0.5 hover:border-brand"><span class="h-1.5 w-1.5 rounded-full bg-brand"></span>Digital account opening</span>
        <span data-reveal data-delay="620" class="flex items-center gap-1.5 rounded-full border border-slate-200 bg-white px-3.5 py-1.5 text-[11.5px] font-medium text-ink2 transition hover:-translate-y-0.5 hover:border-brand"><span class="h-1.5 w-1.5 rounded-full bg-brand"></span>eKYC &amp; video KYC</span>
        <span data-reveal data-delay="680" class="flex items-center gap-1.5 rounded-full border border-slate-200 bg-white px-3.5 py-1.5 text-[11.5px] font-medium text-ink2 transition hover:-translate-y-0.5 hover:border-brand"><span class="h-1.5 w-1.5 rounded-full bg-brand"></span>RD / FD deposits</span>
        <span data-reveal data-delay="740" class="flex items-center gap-1.5 rounded-full border border-slate-200 bg-white px-3.5 py-1.5 text-[11.5px] font-medium text-ink2 transition hover:-translate-y-0.5 hover:border-brand"><span class="h-1.5 w-1.5 rounded-full bg-brand"></span>Co-branded debit cards</span>
        <span data-reveal data-delay="800" class="flex items-center gap-1.5 rounded-full border border-slate-200 bg-white px-3.5 py-1.5 text-[11.5px] font-medium text-ink2 transition hover:-translate-y-0.5 hover:border-brand"><span class="h-1.5 w-1.5 rounded-full bg-brand"></span>Mobile &amp; web banking</span>
        <span data-reveal data-delay="860" class="flex items-center gap-1.5 rounded-full border border-slate-200 bg-white px-3.5 py-1.5 text-[11.5px] font-medium text-ink2 transition hover:-translate-y-0.5 hover:border-brand"><span class="h-1.5 w-1.5 rounded-full bg-brand"></span>Agent-assisted onboarding</span>
    </div>
  </div>
</section>
  ...
  <div class="mx-auto max-w-site px-5">
    ...
    <div class="mt-12 grid gap-5 sm:grid-cols-2 lg:grid-cols-3">
      <article data-reveal data-delay="0" class="card-lift rounded-2xl border border-slate-100 bg-white p-6 shadow-sm">
        ...
        <h3 class="font-display text-[15px] font-bold text-ink">Phygital account opening</h3>
        <p class="mt-2 text-[13px] leading-relaxed text-body">Open CASA accounts digitally or through an agent network, with OTP, Aadhaar XML or biometric eKYC.</p>
      </article>
      <article data-reveal data-delay="80" class="card-lift rounded-2xl border border-slate-100 bg-white p-6 shadow-sm">
        ...
        <h3 class="font-display text-[15px] font-bold text-ink">Co-branded card issuance</h3>
        <p class="mt-2 text-[13px] leading-relaxed text-body">Issue co-branded debit cards linked directly to the neobanking account, ready for POS and ATM use.</p>
      </article>
      <article data-reveal data-delay="160" class="card-lift rounded-2xl border border-slate-100 bg-white p-6 shadow-sm">
        ...
        <h3 class="font-display text-[15px] font-bold text-ink">Mobile &amp; internet banking</h3>
        <p class="mt-2 text-[13px] leading-relaxed text-body">A white-labelled banking app covering balances, transfers, bill pay and UPI &mdash; P2P and P2M.</p>
      </article>
      <article data-reveal data-delay="0" class="card-lift rounded-2xl border border-slate-100 bg-white p-6 shadow-sm">
        <div class="mb-5 inline-flex h-10 w-10 items-center justify-center rounded-xl bg-brandLt text-brand">
        ...
        <h3 class="font-display text-[15px] font-bold text-ink">Kiosk &amp; agent banking</h3>
        <p class="mt-2 text-[13px] leading-relaxed text-body">Basic transactions through self-service kiosks or agent-assisted hubs for underserved geographies.</p>
      </article>
      <article data-reveal data-delay="80" class="card-lift rounded-2xl border border-slate-100 bg-white p-6 shadow-sm">
        <div class="mb-5 inline-flex h-10 w-10 items-center justify-center rounded-xl bg-brandLt text-brand">
        ...
        <h3 class="font-display text-[15px] font-bold text-ink">Document intelligence</h3>
        <p class="mt-2 text-[13px] leading-relaxed text-body">OCR extraction, PAN verification, selfie-to-Aadhaar matching and liveliness checks built in.</p>
      </article>
      <article data-reveal data-delay="160" class="card-lift rounded-2xl border border-slate-100 bg-white p-6 shadow-sm">
        <div class="mb-5 inline-flex h-10 w-10 items-center justify-center rounded-xl bg-brandLt text-brand">
        ...
        <h3 class="font-display text-[15px] font-bold text-ink">One SDK, one audit</h3>
        <p class="mt-2 text-[13px] leading-relaxed text-body">A single certified SDK your compliance team audits once &mdash; no repeated infosec reviews per partner.</p>
      </article>
    </div>
  </div>
</section>
...
<section class="relative overflow-hidden bg-deep py-20 md:py-24">
  ...
  <div class="relative mx-auto max-w-3xl px-5 text-center">
    <h2 data-reveal class="font-display text-[30px] font-extrabold leading-tight tracking-tight text-white sm:text-[40px]">Ready to launch your digital bank?</h2>
    <p data-reveal data-delay="120" class="mx-auto mt-5 max-w-xl text-[15px] leading-relaxed text-slate-400">Talk to our team about a neobanking programme tailored to your license and customer base.</p>
