...
<title>Instant Audio Soundbox â€” Paisape</title>
<meta name="description" content="Never miss a payment confirmation again. Our portable Soundbox provides instant, loud audio alerts for every successful UPI transaction." />
...
<section class="relative overflow-hidden bg-gradient-to-b from-[#EAF4FD] via-[#F4FAFE] to-white pt-36 pb-14 md:pt-44 md:pb-20">
  ...
  <div class="relative mx-auto max-w-site px-5">
    <p data-reveal class="mb-4 text-[11px] font-bold uppercase tracking-[0.18em] text-brand">Merchant Tools &bull; Soundbox</p>

    <h1 class="max-w-3xl font-display text-[36px] font-extrabold leading-[1.14] tracking-tight text-ink sm:text-[44px]">
      <span data-reveal data-delay="80">Instant</span> <span data-reveal data-delay="180" class="text-brand">Audio Soundbox</span>
    </h1>

    <p data-reveal data-delay="300" class="mt-5 max-w-2xl text-[15.5px] leading-relaxed text-body">Never miss a payment confirmation again. Our portable Soundbox provides instant, loud audio alerts for every successful UPI transaction.</p>
    ...
    <div class="mt-8 flex flex-wrap gap-2.5">
        <span data-reveal data-delay="560" class="flex items-center gap-1.5 rounded-full border border-slate-200 bg-white px-3.5 py-1.5 text-[11.5px] font-medium text-ink2 transition hover:-translate-y-0.5 hover:border-brand"><span class="h-1.5 w-1.5 rounded-full bg-brand"></span>Instant Audio Alerts</span>
        <span data-reveal data-delay="620" class="flex items-center gap-1.5 rounded-full border border-slate-200 bg-white px-3.5 py-1.5 text-[11.5px] font-medium text-ink2 transition hover:-translate-y-0.5 hover:border-brand"><span class="h-1.5 w-1.5 rounded-full bg-brand"></span>Multi-Language Support</span>
        <span data-reveal data-delay="680" class="flex items-center gap-1.5 rounded-full border border-slate-200 bg-white px-3.5 py-1.5 text-[11.5px] font-medium text-ink2 transition hover:-translate-y-0.5 hover:border-brand"><span class="h-1.5 w-1.5 rounded-full bg-brand"></span>4G &amp; Wi-Fi Enabled</span>
        <span data-reveal data-delay="740" class="flex items-center gap-1.5 rounded-full border border-slate-200 bg-white px-3.5 py-1.5 text-[11.5px] font-medium text-ink2 transition hover:-translate-y-0.5 hover:border-brand"><span class="h-1.5 w-1.5 rounded-full bg-brand"></span>Long Battery Life</span>
        <span data-reveal data-delay="800" class="flex items-center gap-1.5 rounded-full border border-slate-200 bg-white px-3.5 py-1.5 text-[11.5px] font-medium text-ink2 transition hover:-translate-y-0.5 hover:border-brand"><span class="h-1.5 w-1.5 rounded-full bg-brand"></span>Universal UPI Support</span>
    </div>
  </div>
</section>
  ...
  <div class="mx-auto max-w-site px-5">
    ...
    <div class="mt-12 grid gap-5 sm:grid-cols-2 lg:grid-cols-3">
      <article data-reveal data-delay="0" class="card-lift rounded-2xl border border-slate-100 bg-white p-6 shadow-sm">
        ...
        <h3 class="font-display text-[15px] font-bold text-ink">Instant Audio Alerts</h3>
        <p class="mt-2 text-[13px] leading-relaxed text-body">Receive immediate voice confirmations for every payment, preventing customer disputes and fraud.</p>
      </article>
      <article data-reveal data-delay="80" class="card-lift rounded-2xl border border-slate-100 bg-white p-6 shadow-sm">
        ...
        <h3 class="font-display text-[15px] font-bold text-ink">Multi-Language Support</h3>
        <p class="mt-2 text-[13px] leading-relaxed text-body">Choose from Hindi, English, and multiple regional languages for localized merchant experiences.</p>
      </article>
      <article data-reveal data-delay="160" class="card-lift rounded-2xl border border-slate-100 bg-white p-6 shadow-sm">
        ...
        <h3 class="font-display text-[15px] font-bold text-ink">4G &amp; Wi-Fi Enabled</h3>
        <p class="mt-2 text-[13px] leading-relaxed text-body">Uninterrupted connectivity ensures alerts are delivered instantly, even in crowded or low-network areas.</p>
      </article>
      <article data-reveal data-delay="0" class="card-lift rounded-2xl border border-slate-100 bg-white p-6 shadow-sm">
        <div class="mb-5 inline-flex h-10 w-10 items-center justify-center rounded-xl bg-brandLt text-brand">
        ...
        <h3 class="font-display text-[15px] font-bold text-ink">Long Battery Life</h3>
        <p class="mt-2 text-[13px] leading-relaxed text-body">A powerful built-in battery provides days of standby time on a single charge for continuous operations.</p>
      </article>
      <article data-reveal data-delay="80" class="card-lift rounded-2xl border border-slate-100 bg-white p-6 shadow-sm">
        <div class="mb-5 inline-flex h-10 w-10 items-center justify-center rounded-xl bg-brandLt text-brand">
        ...
        <h3 class="font-display text-[15px] font-bold text-ink">Universal UPI Support</h3>
        <p class="mt-2 text-[13px] leading-relaxed text-body">Announces payments received from any UPI app, ensuring complete coverage for all your customers.</p>
      </article>
      <article data-reveal data-delay="160" class="card-lift rounded-2xl border border-slate-100 bg-white p-6 shadow-sm">
        <div class="mb-5 inline-flex h-10 w-10 items-center justify-center rounded-xl bg-brandLt text-brand">
        ...
        <h3 class="font-display text-[15px] font-bold text-ink">Compact &amp; Portable</h3>
        <p class="mt-2 text-[13px] leading-relaxed text-body">Sleek, space-saving design that fits perfectly on any retail counter without cluttering the billing area.</p>
      </article>
    </div>
  </div>
</section>
...
<section class="relative overflow-hidden bg-deep py-20 md:py-24">
  ...
  <div class="relative mx-auto max-w-3xl px-5 text-center">
    <h2 data-reveal class="font-display text-[30px] font-extrabold leading-tight tracking-tight text-white sm:text-[40px]">Ready to put a Soundbox on every counter?</h2>
    <p data-reveal data-delay="120" class="mx-auto mt-5 max-w-xl text-[15px] leading-relaxed text-slate-400">Talk to our team about device pricing, branding and bulk rollout for your merchant network.</p>
